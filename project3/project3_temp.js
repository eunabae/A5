...
// // img.src = 'https://drive.google.com/drive/u/0/my-drive/heightmap.png';
...
const gridWidth = imgData.width/4 ; // 가로
const gridDepth = imgData.height/4; // 세로

// const gridWidth = 40;
// const gridDepth = 40;

console.log(" gridWidth " + gridWidth);
console.log(" gridDepth " +  gridDepth);

const gridPoints = [];

for (let y = 0; y <= gridWidth; ++y) {
  for (let x = 0; x <= gridDepth; ++x) {
    const offset = (y * imgData.width + x) * 4;
    // height 0 to 10
    const height = imgData.data[offset] *10/ 255;
    gridPoints.push(x, y, height);
    // gridPoints.push(x,y,0);
  }
}

const gridIndices = [];
const rowStride = gridWidth;
...
const target = [gridWidth / 2, gridDepth / 2, 0];
const up = [0, 0, 1];
...
//  original
// //https://stackoverflow.com/questions/59253917/how-to-import-a-height-map-in-webgl
...
//     const modelView = m4.translate(view, imgData.width / -2, 0, imgData.height / -2)
